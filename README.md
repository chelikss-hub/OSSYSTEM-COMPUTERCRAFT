...
Хорошая текстовая ОС на computer craft
...
В настоящее время проект временно заморожен, IceCubeOS развивается быстрее. когда будет релиз IceCubeOS я вернусь к этой системе. 
